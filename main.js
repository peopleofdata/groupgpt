      ...
      html += `
            <div classname='response-box'>
                <div classname='user-box' style='display: flex; padding: 1rem'>
                    <image src='https://png.pngtree.com/png-vector/20220210/ourmid/pngtree-police-officer-faceless-icon-png-image_4384691.png' style='width: 50px; height: 50px; background-color: black; padding: 0.25rem; border-radius: 5px;'/>
      ...
      html += `
            <div classname='response-box'>
                <div classname='box-box' style='display: flex; padding: 1rem; background-color: ghostwhite; border-top: 1px solid whitesmoke; border-bottom: 1px solid whitesmoke;'>
                    <image src='https://cdn0.iconfinder.com/data/icons/black-logistics-icons/256/Robot_head.png' style='width: 50px; height: 50px; background-color: black; padding: 0.25rem; border-radius: 5px;'/>
